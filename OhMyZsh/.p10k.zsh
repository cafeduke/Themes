# Generated by Powerlevel10k configuration wizard on 2019-10-19 at 20:15 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=026
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local    loading='%15F'  # grey foreground
    else
  ...
  typeset -g POWERLEVEL9K_VCS_CLOBBERED_BACKGROUND=124
  typeset -g POWERLEVEL9K_VCS_CLOBBERED_FOREGROUND='white'
